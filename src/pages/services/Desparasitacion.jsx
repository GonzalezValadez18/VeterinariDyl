...
const Desparasitacion = () => {
    const whatsappMessage =
        "Hola, buenas tardes, me gustaria agendar una cita para desparasitar a mi mascota.🐶🐱💊";
        ...
        <>
                ...
                <div className="row flex-column flex-md-row align-items-center">
                    ...
                    <div className="col-12 col-md-6 d-flex flex-column align-items-center text-center">
                        ...
                        <p className="mt-3 px-3 px-md-0">
                            Si su mascota presenta nematodos (gusanos redondos)
                            o cestodos (gusanos planos o tenias), tu veterinario
                ...
                <div className="row p-5">
                    <div className="col-12 col-md-6 d-flex flex-column align-items-center text-center justify-content-center m-auto">
                        ...
                        >
                            ...
                            nuestras mascotas son los nematodos intestinales y
                            los cestodos (tenias), aunque también existen
                            nematodos pulmonares, cardiacos y oculares.
                            <br />
                            <br />
                            Las mascotas pueden contraerlos al entrar en
                            contacto con alimentos, agua, tierra, heces o
                            roedores contaminados. Además, muchos cachorros se
                            parasitan directamente a través de la leche materna.
                            <br />
                            <br />
            ...
            <div className="container mt-5">
                <div className="row flex-column flex-md-row align-items-center">
                    ...
                    <div className="col-12 col-md-6 d-flex flex-column align-items-center text-center">
                        <h2 className="text-info fs-1 fw-bold">
                            ¿Cuáles son los síntomas de los parásitos internos
                        ...
                        <div className="accordion-item">
                            ...
                            >
                                <div className="accordion-body">
                                    ...
                                    nemátodos y cestodos, siendo los niños los
                                    más vulnerables. Los síntomas incluyen tos,
                        ...
                        <div className="accordion-item">
                            <h2 className="accordion-header" id="headingfaq2">
                                ...
                                >
                                    <strong>
                                        {" "}
                                        ¿Como puedo proteger a mi mascotas
                                        contra parasitos internos?
                                    </strong>
                                </button>
                            </h2>
                            <div
                            ...
                            >
                                <div className="accordion-body">
                                    La mejor forma de proteger a su mascota es
                                    con desparasitaciones periódicas y
                                    frecuentes. No dudes en consultar a tu
                                    veterinario sobre las mejores opciones de
                                    tratamiento disponibles. También debes
                                    llevar a cabo otras medidas preventivas como
                                    desinfectar regularmente los cuencos de
                                    comida y agua de tu mascota, retirar los
                                    excrementos de tu mascota, desinfectar las
                                    zonas donde defecan y lavarte bien las manos
                                    después.
                                </div>
                            </div>
                        </div>
